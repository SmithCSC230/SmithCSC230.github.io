...
Example:
If you score 70% on a topic on Midterm 1 and 95% on Midterm 3, your final score for that topic is 95%.
...
cannot receive partial credit, even if some parts are correct.
...
You can request an automatic 72-hour extension ahead of the deadline using the extension request form: https://docs.google.com/forms/d/e/1FAIpQLSc3QMRpoOr5WqiYz2cQlBssQPz4uA9wtlrXh5H2VrlfYfsfrg/viewform?usp=header.
...
- Review the autograder feedback.
Then ask — with context — via the appropriate channel. We want you to succeed, and clear expectations are part of that.
